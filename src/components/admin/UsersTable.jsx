        ...
        <table className="w-full min-w-[1100px] text-left text-sm">
          <thead className="text-gray-400 border-b border-gray-800 sticky top-0 bg-gray-900 z-10">
            <tr>
              ...
              <th className="p-3">Group Referrals</th>
              <th className="p-3">Action</th>
            </tr>
          </thead>
          <tbody>
            {filteredUsers.map((user, index) => {
              // Bereken het aantal gebruikers dat door deze gebruiker is uitgenodigd
              ...
              return (
                <tr key={user.id || index} className="border-b border-gray-800/50 hover:bg-gray-800/30">
                  ...
                  <td className="p-3 font-bold text-blue-400 text-center">{groupReferralsCount}</td>
                  <td className="p-3">
                    <button
